...
| **Setor** | ___ |
| **IDC** | ___ / 100 |
| **Classificação** | ANDAIME / ANDAIME COM RESSALVAS / ZONA CINZENTA / TETO PROVÁVEL / TETO TOTAL |
| **Tipo taxonômico** | ___ |
| **Eixo D** | D+ / D- |
| **Hipótese inicial confirmada?** | SIM / PARCIALMENTE / NÃO |
...
```
D1 (RH/Glassdoor)    ___ / 35   × 25%  =  ___
D2 (LinkedIn)         ___ / 30   × 20%  =  ___
D3 (Modelo/RI)        ___ / 35   × 20%  =  ___
D4 (Reclame Aqui)     ___ / 30   × 20%  =  ___
D5 (Jusbrasil)        ___ / 30   × 15%  =  ___
                                     ─────────
IDC TOTAL:                               ___
```

**Modificador D- aplicado?** SIM (-10) / NÃO
...
### Glassdoor (s1)
- **Rating geral:** ___/5 | **Recomendação:** ___%
- **Achados chave:** ___
- **Contradição interna identificada?** ___

### LinkedIn (s2)
- **Movimento ex-colaboradores:** ___% ascendente
- **Achados chave:** ___

### Reclame Aqui (s3a)
- **Nota:** ___/10 | **Resolução:** ___%
- **Achados chave:** ___

### Jusbrasil (s3b)
- **Volume de processos:** ___
...
## BIFURCAÇÕES IDENTIFICADAS

> Uma bifurcação é quando a empresa é andaime para um grupo e teto para outro.

| Dimensão | Grupo ANDAIME | Grupo TETO |
|---|---|---|
| | | |
| | | |
...
### Mais reveladoras (TETO)
1. "___" — [fonte]
2. "___" — [fonte]
3. "___" — [fonte]

### Mais reveladoras (ANDAIME)
1. "___" — [fonte]
2. "___" — [fonte]
3. "___" — [fonte]
...
**Hipótese inicial:** ___

**O que os dados confirmaram:** ___

**O que os dados contradisseram:** ___

**Hipótese revisada:** ___

---

## COMPARAÇÃO COM SETOR

*A preencher quando análises cruzadas estiverem disponíveis.*

---

*sintese.md · IDC [NOME_EMPRESA] · Ascendimacy*
